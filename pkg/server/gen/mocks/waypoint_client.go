...
func (_m *WaypointClient) DeleteConfig(ctx context.Context, in *gen.ConfigDeleteRequest, opts ...grpc.CallOption) (*gen.ConfigDeleteResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
// UI_GetPipelineRun provides a mock function with given fields: ctx, in, opts
func (_m *WaypointClient) UI_GetPipelineRun(ctx context.Context, in *gen.UI_GetPipelineRunRequest, opts ...grpc.CallOption) (*gen.UI_GetPipelineRunResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if rf, ok := ret.Get(0).(func(context.Context, *gen.UI_GetPipelineRunRequest, ...grpc.CallOption) *gen.UI_GetPipelineRunResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.UI_GetPipelineRunRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
