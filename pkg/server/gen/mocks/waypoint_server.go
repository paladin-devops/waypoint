...
func (_m *WaypointServer) GetLatestDeployment(_a0 context.Context, _a1 *gen.GetLatestDeploymentRequest) (*gen.GetDeploymentResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *gen.GetDeploymentResponse
	if rf, ok := ret.Get(0).(func(context.Context, *gen.GetLatestDeploymentRequest) *gen.GetDeploymentResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
// INTERNAL_AdditionalMessages provides a mock function with given fields: _a0, _a1
func (_m *WaypointServer) INTERNAL_AdditionalMessages(_a0 context.Context, _a1 *emptypb.Empty) (*gen.UI_ListEventSchemasResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *gen.UI_ListEventSchemasResponse
	if rf, ok := ret.Get(0).(func(context.Context, *emptypb.Empty) *gen.UI_ListEventSchemasResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
// UI_ListEvents provides a mock function with given fields: _a0, _a1
func (_m *WaypointServer) UI_ListEvents(_a0 context.Context, _a1 *gen.UI_ListEventsRequest) (*gen.UI_ListEventsResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *gen.UI_ListEventsResponse
	if rf, ok := ret.Get(0).(func(context.Context, *gen.UI_ListEventsRequest) *gen.UI_ListEventsResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.UI_ListEventsRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *WaypointServer) UI_ListPipelines(_a0 context.Context, _a1 *gen.UI_ListPipelinesRequest) (*gen.UI_ListPipelinesResponse, error) {
	...
	if rf, ok := ret.Get(0).(func(context.Context, *gen.UI_ListPipelinesRequest) *gen.UI_ListPipelinesResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.UI_ListPipelinesRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
// UpdateAddOn provides a mock function with given fields: _a0, _a1
func (_m *WaypointServer) UpdateAddOn(_a0 context.Context, _a1 *gen.UpdateAddOnRequest) (*gen.UpdateAddOnResponse, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *gen.UpdateAddOnResponse
	if rf, ok := ret.Get(0).(func(context.Context, *gen.UpdateAddOnRequest) *gen.UpdateAddOnResponse); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *gen.UpdateAddOnRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
