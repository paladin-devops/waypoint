...
import (
	...
	dockerref "github.com/paladin-devops/waypoint/builtin/docker/ref"
	"github.com/paladin-devops/waypoint/builtin/nomad/canary"
	"github.com/paladin-devops/waypoint/builtin/packer"
	"github.com/paladin-devops/waypoint/internal/factory"

	"github.com/paladin-devops/waypoint/builtin/aws/alb"
	"github.com/paladin-devops/waypoint/builtin/aws/ami"
	"github.com/paladin-devops/waypoint/builtin/aws/ec2"
	"github.com/paladin-devops/waypoint/builtin/aws/ecr"
	awsecrpull "github.com/paladin-devops/waypoint/builtin/aws/ecr/pull"
	"github.com/paladin-devops/waypoint/builtin/aws/ecs"
	"github.com/paladin-devops/waypoint/builtin/aws/lambda"
	lambdaFunctionUrl "github.com/paladin-devops/waypoint/builtin/aws/lambda/function_url"
	"github.com/paladin-devops/waypoint/builtin/aws/ssm"
	"github.com/paladin-devops/waypoint/builtin/azure/aci"
	"github.com/paladin-devops/waypoint/builtin/consul"
	"github.com/paladin-devops/waypoint/builtin/docker"
	dockerpull "github.com/paladin-devops/waypoint/builtin/docker/pull"
	"github.com/paladin-devops/waypoint/builtin/exec"
	"github.com/paladin-devops/waypoint/builtin/files"
	"github.com/paladin-devops/waypoint/builtin/google/cloudrun"
	"github.com/paladin-devops/waypoint/builtin/k8s"
	k8sapply "github.com/paladin-devops/waypoint/builtin/k8s/apply"
	k8shelm "github.com/paladin-devops/waypoint/builtin/k8s/helm"
	"github.com/paladin-devops/waypoint/builtin/nomad"
	"github.com/paladin-devops/waypoint/builtin/nomad/jobspec"
	"github.com/paladin-devops/waypoint/builtin/null"
	"github.com/paladin-devops/waypoint/builtin/pack"
	"github.com/paladin-devops/waypoint/builtin/tfc"
	"github.com/paladin-devops/waypoint/builtin/vault"
)
